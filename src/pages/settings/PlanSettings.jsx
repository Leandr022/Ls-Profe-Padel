    ...
    return (
      <div className="max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto px-5 py-6 md:px-8 pb-10 fade-in">
        ...
        <div className="card p-4 mt-4 bg-brand/10 border-brand/30 text-center">
          ...
          <p className="text-sm text-slate-400 mt-1">Esta cuenta es la del dueño de LsPadelPro — no tiene vencimiento ni límite de plan.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto px-5 py-6 md:px-8 pb-10 fade-in">
      ...
      {location.state?.blocked && (
        <div className="card p-3 mb-4 bg-red-950/40 border-red-800/40 text-red-400 text-sm font-semibold text-center">
          {access.source === 'trial' ? 'Tu prueba gratuita terminó.' : 'Tu plan venció.'} Elegí uno para seguir usando LsPadelPro.
        </div>
      )}
      ...
      <div className="card p-4 mb-4">
        ...
        <a href="mailto:leandro.santagada@icloud.com?subject=Plan personalizado LsPadelPro" className="btn-secondary block text-center">
          Contáctanos
        </a>
      </div>
