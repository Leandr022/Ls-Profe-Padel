...
// registraron en LsPadelPro: en qué estado de acceso están (prueba, plan activo, vencido)
  ...
  return (
    <div className="max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto px-5 py-6 md:px-8 pb-16 fade-in">
      ...
      <p className="text-slate-400 text-sm mb-5">
        Todos los que se crearon una cuenta en LsPadelPro, con su estado de acceso actual.
      </p>
