...
const SECTIONS = [
  {
    title: '1. Objeto',
    body: [
      'Los presentes Términos y Condiciones (en adelante, los "Términos") regulan el acceso y uso de la aplicación LsPadelPro (en adelante, el "Servicio" o la "Plataforma"), destinada a que profesionales de la enseñanza del pádel (en adelante, el "Usuario") gestionen horarios, alumnos y cobros. La creación de una cuenta y/o el uso del Servicio implica la aceptación plena y sin reservas de estos Términos.',
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      'Si un cobro no pudiera efectuarse, el Usuario conservará el acceso a las funcionalidades del Servicio durante un plazo de gracia de tres (3) días corridos desde la fecha en que el cobro debía efectivizarse, a fin de regularizar su medio de pago. Vencido dicho plazo sin que el pago se regularice, LsPadelPro podrá suspender el acceso hasta que ello ocurra o se contrate un nuevo plan.',
    ],
  },
  {
    title: '6. Programa de embajadores',
    body: [
      'LsPadelPro podrá otorgar, a su exclusivo criterio, acceso gratuito y permanente a determinados Usuarios en el marco de un programa de embajadores. Dicho beneficio es intransferible, no genera derecho adquirido alguno y puede ser revocado por LsPadelPro en cualquier momento, en particular ante un uso indebido del Servicio.',
      'Adicionalmente, LsPadelPro podrá reconocer a los Usuarios que participen del programa de embajadores (en adelante, los "Embajadores") una comisión sobre los pagos efectivamente percibidos de los Usuarios que se hayan registrado utilizando su enlace de referido (en adelante, los "Referidos"), durante un período determinado a partir del primer pago de cada Referido. El porcentaje de la comisión, la duración de dicho período y las condiciones de acumulación entre distintos planes se informan dentro de la Plataforma y podrán ser modificados por LsPadelPro con notificación previa dentro de la aplicación, sin efecto retroactivo sobre comisiones ya devengadas.',
      'LsPadelPro podrá además reconocer a los Embajadores bonificaciones adicionales de monto fijo al alcanzar determinada cantidad de Referidos que hayan completado el período consecutivo de permanencia informado dentro de la Plataforma. Las condiciones, montos y umbrales de estas bonificaciones se informan dentro de la aplicación y podrán ser modificados por LsPadelPro con notificación previa, sin afectar bonificaciones ya devengadas y confirmadas.',
      'El pago de comisiones y bonificaciones se realiza mediante transferencia al alias de cobro que el Embajador cargue en su panel dentro de la Plataforma, siendo de su exclusiva responsabilidad la exactitud de dicho dato. LsPadelPro no será responsable por transferencias realizadas a un alias incorrectamente cargado por el Embajador.',
    ],
  },
  {
    title: '7. Limitación de responsabilidad',
    body: [
      'En la máxima medida permitida por la legislación aplicable, LsPadelPro no será responsable por daños directos, indirectos, incidentales, especiales o consecuentes derivados del uso o la imposibilidad de uso del Servicio, incluyendo -sin limitarse a- la pérdida de datos, pérdida de ingresos o interrupción de la actividad comercial del Usuario.',
    ],
  },
  {
    title: '8. Vigencia y terminación',
    body: [
      'Estos Términos rigen desde la creación de la cuenta y se mantienen vigentes mientras el Usuario utilice el Servicio. El Usuario podrá dar de baja su cuenta en cualquier momento. LsPadelPro podrá suspender o cancelar cuentas que incumplan estos Términos o la normativa vigente.',
    ],
  },
  {
    title: '9. Modificaciones',
    body: [
      'LsPadelPro podrá modificar estos Términos en cualquier momento. Los cambios sustanciales serán notificados dentro de la Plataforma. El uso continuado del Servicio con posterioridad a dicha notificación implica la aceptación de los Términos modificados.',
    ],
  },
  {
