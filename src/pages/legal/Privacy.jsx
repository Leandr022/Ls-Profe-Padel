...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      'Las preferencias de visualización (tema y tamaño de letra) se almacenan localmente en el dispositivo del Usuario y no se transmiten a los servidores de LsPadelPro. Las tecnologías de analítica y de medición publicitaria utilizadas se detallan en la Sección 10.',
    ],
  },
  {
    ...
    body: [
      ...
      'Utilizamos además el Píxel de Meta y la API de Conversiones de Meta (Meta Pixel / Conversions API), herramientas provistas por Meta Platforms, Inc., para medir la efectividad de las campañas publicitarias de LsPadelPro. El Píxel de Meta se ejecuta en cada visita al sitio (únicamente en producción, profepadel.com, nunca en ambientes de prueba) y registra la visita mediante sus propias cookies. En los momentos de registro, activación de la cuenta, inicio de la contratación de un plan (checkout) o pago, el servidor de LsPadelPro también envía a Meta el correo electrónico y un identificador interno del Usuario, ambos procesados con la función hash SHA-256, junto con identificadores técnicos asociados al Píxel cuando están disponibles. No se envían datos de Alumnos ni datos operativos de la cuenta (horarios, tarifas, notas).',
    ],
  },
  {
    title: '11. Cesión a terceros',
    body: [
      'LsPadelPro no vende, alquila ni cede a terceros los datos personales de Usuarios ni de Alumnos, salvo (i) a Mercado Pago, en su carácter de procesador de pagos, en la medida necesaria para gestionar los planes de suscripción; (ii) a Meta Platforms, Inc. y a Microsoft Corporation, en la medida necesaria para la medición de campañas publicitarias y la analítica de uso descriptas en la Sección 10; o (iii) requerimiento de autoridad competente conforme a la legislación aplicable.',
    ],
  },
  {
